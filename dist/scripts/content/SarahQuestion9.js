...
class SarahQuestion9 extends Content {
    constructor(){
        ...
        this.$questionExplanation = document.querySelector(`.question-9-explanation`) 
    ...
    onClickNext(){
        ...
        if(!this.isScoreShown){
            ...
            this.gotoNextStep()
            eventSystem.publish(Events.ON_PROGRESS_UPDATE, 9)
