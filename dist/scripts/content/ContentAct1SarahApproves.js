...
class ContentAct1SarahApproves extends Content {
    constructor() {
        ...
        const self = this;
        (this.greetingsText = `I'm happy to bring you in! You're ready to meet the rest of the team <strong>in the field. We're going to the Amazon forest!</strong>`),
