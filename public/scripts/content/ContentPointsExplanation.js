...
class ContentPointsExplanation extends Content {
    ...
    preactivateContent() {
        ...
        if (punctuation <= 50) {
            ...
            explanationDescription = `Very <strong>thoughtful responses!</strong><br>Your ability to manage complex challenges and make crucial decisions advocating for the environment demonstrates your exceptional strategic skills. You're on track to guide established companies toward a greener future!<br><br>
