...
class ContentAct2PreQuestion extends Content {
    constructor() {
        ...
        this.texts = [
            ...
            "Local communities are skeptical but your dedication and visible results are starting to gain",
            "their <strong>support</strong> and <strong>trust</strong> in Rainforest Security and Awareness Intelligence",
        ];
