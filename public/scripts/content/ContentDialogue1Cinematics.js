...
class ContentDialogue1Cinematics extends Content {
    constructor() {
        super(Steps.SARAH_DIALOGUE_1)
        ...
        this.label = document.getElementById("speech-content-dialogue-1")
        this.button = document.getElementById("content-cinematic-dialogue-1-button")
        ...
        anime.set(`#step-${this.contentID} #sarah-dialogue-1, #step-${this.contentID} #sarah-dialogue-1-name`, {
    ...
    activateContent(){
        const self = this
        this.showCharacter("sarah-dialogue-1", 0, ()=>{
...
export default ContentDialogue1Cinematics