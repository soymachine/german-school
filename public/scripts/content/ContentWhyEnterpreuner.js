...
class ContentWhyEnterpreuner extends Content {
    constructor() {
        ...
        // Data
        this.responses = ["To solve an existing problem in the market", "To explore my creativity to its full potential", "To be my own boss and lead a team", "To make an impact in society"];
